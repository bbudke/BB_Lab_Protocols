# Determination Of DNA Content And EdU Incorporation By Flow Cytometry
By Brian Budke
...
- The click reaction can also be done with the azide and alkyne groups on the opposite pair of molecules; e.g., a reaction with cyanine 5 alkyne and 5-(azidomethyl)-2'deoxyuridine (AmdU). In principle, this would allow for two-color click reactions to be performed.
...
- Click reaction buffer
	...
	- Make fresh within minutes of use. Add reagents to water in the order listed above. Protect from light.
- FACS resuspension buffer
	- 1X PBS
	- 1 mM EDTA
	- 1% BSA
	- 0.5% Triton X-100
	- 1 μg/ml DAPI (Added from a 1 mg/ml stock made in water. Also make a smaller aliquot of resuspension buffer without DAPI for the DAPI-negative controls)
